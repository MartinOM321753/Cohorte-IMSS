...
public class PermisoInitializer {
    ...
    private static final List<String[]> CATALOGO_PERMISOS = List.of(
            ...
            new String[]{"MUESTRAS_ESCANEAR", "MUESTRAS", "Buscar muestras leyendo su etiqueta con camara o lector"},
            new String[]{"MUESTRAS_CARGA_MASIVA", "MUESTRAS", "Cargar muestras y alicuotas desde un archivo"},
            ...
            // Separado del de plantillas a proposito: una formula equivocada afecta a
            // todos los reportes que la usen, no solo al que se esta editando.
            new String[]{"REPORTES_FORMULAS_EDITAR", "REPORTES", "Crear y modificar formulas de calculo"},
            // Aparte del de emitir: emitir saca el documento de un participante, exportar
            // baja los datos de toda la cohorte en un archivo que sale del sistema.
            new String[]{"REPORTES_EXPORTAR", "REPORTES", "Descargar datos de participantes en archivo"},
    ...
    private static final Set<String> PERMISOS_LABORATORISTA = Set.of(
            ...
            "MUESTRAS_CARGA_MASIVA", "MUESTRAS_CREAR", "MUESTRAS_DAR_BAJA", "MUESTRAS_EDITAR",
    ...
    private static final Set<String> PERMISOS_ENCARGADO = Set.of(
            ...
            "ESTUDIOS_MUESTRA_LOOKUP", "INSTITUCIONES_LOOKUP", "MUESTRAS_CARGA_MASIVA",
            "MUESTRAS_CREAR",
            "MUESTRAS_EDITAR", "MUESTRAS_ELIMINAR", "MUESTRAS_ESCANEAR", "MUESTRAS_IMPRIMIR",
